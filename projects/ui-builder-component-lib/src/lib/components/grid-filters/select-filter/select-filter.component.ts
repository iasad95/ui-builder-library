...
import { SelectFilterGridMiscellaneousData } from './select-filter.interface';
@Component({
...
export class SelectFilterComponent implements OnInit, OnChanges {
  ...
  public selectFilterGridMiscellaneousData: SelectFilterGridMiscellaneousData;
  ...
  ngOnInit(): void {
    this.selectFilterGridMiscellaneousData = this.gridService.gridMiscellaneousData?.gridFiltersModal?.selectFilter;
