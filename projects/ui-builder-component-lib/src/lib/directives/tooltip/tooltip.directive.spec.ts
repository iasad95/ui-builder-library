...
@Component({
  template: ` <label style="position: fixed; top: 100px" [libTooltip]="'Tooltip'" [directionPreference]="top" id="top">Text</label>
    <label [libTooltip]="'Tooltip'" [directionPreference]="right" id="right">Text</label>
    <label [libTooltip]="'Tooltip'" [directionPreference]="bottom" id="bottom">Text</label>
    <label [libTooltip]="'Tooltip'" [directionPreference]="left" id="left">Text</label>`,
})
class HostComponent {
