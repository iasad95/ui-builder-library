...
export class TooltipDirective implements OnDestroy {
  ...
  @Input() holdTimeForMobile: number = 1000;
  ...
  private setComponentVariables(compRef: ComponentRef<TooltipComponent>, directionPreference: TooltipDirectionPreference) {
    compRef.instance.message = this.libTooltip;
    compRef.instance.title = this.title;
    compRef.instance.hideIcon = this.hideIcon;
